    ...
    <div className="bg-gradient-to-b from-[#1A237E]/10 to-transparent">
      <div className="container mx-auto px-6">
        ...
        <div className="py-20 text-center">
          <h1 className="text-5xl font-bold mb-6 text-[#1A237E]">
          ...
          <a
            href="/scan"
            className="bg-[#1A237E] text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-[#0D1453] transition-colors"
          >
            Start Scanning
          </a>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 py-16">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold mb-4 text-[#1A237E]">Smart Dependency Analysis</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold mb-4 text-[#1A237E]">Complex Upgrades Made Simple</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold mb-4 text-[#1A237E]">Environmental Awareness</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold mb-4 text-[#1A237E]">Holistic Upgrade Strategy</h2>
            <p className="text-gray-600 leading-relaxed">
